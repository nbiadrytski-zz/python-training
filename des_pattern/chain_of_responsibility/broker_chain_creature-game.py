...
class Event(list):  # a list of functions you can call
...
class Creature:
    def __init__(self, game, name, attack, defense):  # reference central broker which is game
...
class CreatureModifier(ABC):
    ...
    def __enter__(self):  # to create context manager
        return self
