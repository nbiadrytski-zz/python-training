...
if __name__ == '__main__':
    ...
    parser.add_option("-p", "--port", dest="serial",
                      help="Serial port, a number, defualt = '/dev/tty0'", type=str, default='/dev/tty.usbserial-14200')
    ...
    parser.add_option("-P", "--localport", dest="port",
                      help="TCP/IP port on which to run the server (default 9100)", type=int, default=65432)
